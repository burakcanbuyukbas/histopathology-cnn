...
train_generator, val_generator, test_generator = get_data_generators(image_size, batch_size, model='vgg')
...
model.load_weights("checkpoints/vgg/checkpoint-03-0.81.hdf5")
print("Model loaded.")
...
model.save("model_vgg_" + str(image_size) + "px.h5")
np.save("model/model_vgg_" + str(image_size) + "px_losshistory.npy", loss_history)
np.save("model/model_vgg_" + str(image_size) + "px_losshistory.npy", acc_history)
